...
export async function seedQuestions(prisma: PrismaClient) {
  ...
  await upsertOptions(prisma, [
    { question_id: q001.id, order: 1, price_impact: 1500, time_impact: 21, complexity_impact: 15, weight: 1.0 },  // Website Institucional
    { question_id: q001.id, order: 2, price_impact: 800, time_impact: 10, complexity_impact: 10, weight: 1.0 },   // Landing Page
    { question_id: q001.id, order: 3, price_impact: 5000, time_impact: 45, complexity_impact: 50, weight: 1.2 },  // E-commerce
    { question_id: q001.id, order: 4, price_impact: 8000, time_impact: 60, complexity_impact: 65, weight: 1.3 },  // Sistema Web
    { question_id: q001.id, order: 5, price_impact: 12000, time_impact: 90, complexity_impact: 70, weight: 1.4 }, // App Mobile
    { question_id: q001.id, order: 6, price_impact: 15000, time_impact: 75, complexity_impact: 80, weight: 1.5 }, // Automação e IA
  ])
  ...
  // ──────────────────────────────────────────────────────────────
  // BLOCO 7: CONTEXT — universal (Q090-Q093)
  // ──────────────────────────────────────────────────────────────
  ...
  const contextQuestions = [
    ...
    { code: 'Q093', order: 93, type: 'MULTIPLE_CHOICE', impacts: [
      { price: 0, time: 0, complexity: 0, w: 1.0 },
  ...
  // ──────────────────────────────────────────────────────────────
  // BLOCO 8: LEAD — coleta de dados do cliente (Q100-Q105)
  // ──────────────────────────────────────────────────────────────
